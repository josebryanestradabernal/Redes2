            ...
            for (;;) {
                ...
                switch (Integer.parseInt("" + (char) inputtext.readLine().toCharArray()[0])) {
                    case 1:
                        ...
                        if(item.equals("0")){
                            ...
                            switch(inputtext.readLine()){
                                case "1":
                                    System.out.println("imprimiento nombre de las imagenes");
                                    break;
                                case "2":
                    ...
                    case 3:
                        ...
                        try{
                            carrito = (ArrayList<ItemCarrito>) ois.readObject();
                       }catch(ClassNotFoundException e){
                        System.out.println("El cliente no mando el carrito");
                        e.printStackTrace();
                        }
                       
                        System.out.println("Se vendio: "+ carrito.size());
                        break;
                    default:
                        break;
                }
